...
function LogIn(props: { setModalIsOpen?: () => void }) {
      ...
      <div className={classes.container}>
        {singIn ? (
                ...
                <button
                  onClick={() => {
                    singin(email, password)
                      .then((res) => {
                        if (typeof res === "string") return trowError();
                        console.log(res);
                        if (props.setModalIsOpen && res) props.setModalIsOpen();
                      })
                      .catch((error) => trowError());
                  }}
          ...
          <>
            ...
            <Link to="/reg">
              <button onClick={props.setModalIsOpen} className={classes.button}>
                Registration
              </button>
            </Link>
          </>
