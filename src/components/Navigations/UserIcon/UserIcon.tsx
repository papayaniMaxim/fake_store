        ...
        <>
            <motion.div
                ...
                <motion.div
                    ...
                    transition={{ type: 'spring', stiffness: 300, delay: 2 }} className={classes.iconContainer}>
                    {userInfo?.login ?
                        <div className={styles.wrapper}><div className={styles.subtitle}>{userInfo?.firstName}</div></div>
                        : null}
                    <img className={classes.card_icon} src={userInfo?.login
                        ? 'https://i.ibb.co/M8p6YfC/user-3296.png'
                        : 'https://cdn-icons-png.flaticon.com/512/3580/3580168.png'} alt="Log in icon" />
                </motion.div>
            </motion.div>
            {isOpen &&
